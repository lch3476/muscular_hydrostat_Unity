...
//         Vector3[,] dpoints = new Vector3[facesNum, verticesPerFace];
...
//         Vector3[] centroids = new Vector3[facesNum];
//         Vector3[] dcentroids = new Vector3[facesNum];
//         Vector3[,] rel = new Vector3[facesNum, verticesPerFace];
//         Vector3[,] drel = new Vector3[facesNum, verticesPerFace];
//         for (int f = 0; f < facesNum; f++)
//         {
//             Vector3 sum = Vector3.zero;
//             Vector3 dsum = Vector3.zero;
//             for (int v = 0; v < verticesPerFace; v++) { sum += points[f, v]; dsum += dpoints[f, v]; }
//             centroids[f] = sum / verticesPerFace;
//             dcentroids[f] = dsum / verticesPerFace;
//             for (int v = 0; v < verticesPerFace; v++)
//             {
...
//         Vector3[] normals = new Vector3[facesNum];
//         for (int f = 0; f < facesNum; f++)
//         {
//             Vector3[] relVec = new Vector3[verticesPerFace];
//             for (int v = 0; v < verticesPerFace; v++) relVec[v] = rel[f, v];
...
//         float[,,] jacobians = new float[facesNum * verticesPerFace, N, D];
//         for (int f = 0; f < facesNum; f++)
//         {
//             for (int v = 0; v < verticesPerFace; v++)
//             {
...
//                 {
//                     float coeff = 0f;
//                     for (int vv = 0; vv < verticesPerFace; vv++) if (faceIndices[f, vv] == p) { coeff -= 1f / verticesPerFace; }
...
//         float[,,] djac_dts = new float[facesNum * verticesPerFace, N, D];
